...
async def welcome_page(request: Request, session: DBSession):
    ...
    return _coming_soon(request, user, "welcome",
        ...
        icon="👋",
        description=(
            "Автоматически встречайте новых участников группы персональным сообщением, "
            "рассказывайте о правилах и помогайте быстро освоиться в сообществе."
        ),
        features=[
            {
                "icon": "📩",
                "title": "Персональное приветственное сообщение",
                "description": (
                    "Когда новый участник вступает в группу, бот автоматически отправляет "
                    "ему личное сообщение с приветствием. В тексте можно использовать "
                    "переменные: {{имя}}, {{группа}}, {{дата вступления}}."
                ),
            },
            {
                "icon": "📋",
                "title": "Пост-приветствие в группе",
                "description": (
                    "Помимо личного сообщения, бот публикует в группе короткое "
                    "объявление: «Добро пожаловать, @username!». Пост автоматически "
                    "удаляется через заданное время, чтобы не засорять ленту."
                ),
            },
            {
                "icon": "📜",
                "title": "Правила и онбординг",
                "description": (
                    "Вместе с приветствием бот присылает ссылку на правила, FAQ "
                    "или приветственный пост с кнопкой «Ознакомился». До подтверждения "
                    "новый участник видит ограниченный набор сообщений."
                ),
            },
            {
                "icon": "🎁",
                ...
                "description": (
                    "Настройте выдачу промокода, ссылки на закрытый контент или "
                    "стартового бонуса в системе геймификации каждому новому участнику. "
                    "Мотивируйте новичков сразу начать взаимодействовать с сообществом."
                ),
            },
            {
                "icon": "⏰",
                ...
                "description": (
                    "Создайте цепочку из 3–5 сообщений, которые бот присылает "
                    "новичку в течение первых дней: что почитать, как участвовать, "
                    "анонсы ближайших событий. Мягкое погружение в жизнь сообщества."
                ),
            },
            {
                "icon": "📊",
                ...
                "description": (
                    "Видите, сколько человек вступило за день/неделю/месяц, "
                    "какой процент открыл приветственное сообщение и нажал кнопки. "
                    "Отслеживайте динамику роста аудитории в разрезе источников."
                ),
            },
        ],
    )
